...
export default function Dashboard() {
  ...
  useEffect(() => {
    ...
    axios
      .get("https://ec2-65-2-78-117.ap-south-1.compute.amazonaws.com:8000/user/dashboard", {
        headers: {
        ...
        {loading ? (
          ...
          <Card width="full h-auto md:rounded-xl">
            <div className="flex flex-col md:flex-row md:items-start items-center">
              ...
              <button
                className="bg-yellow-300 py-1 px-3 rounded-lg hover:bg-red-300 md:mt-0 mt-3"
                onClick={() => {
