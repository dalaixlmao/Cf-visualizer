export default function LoaderDashboard(){
    return <div
    role="status"
    className="w-full p-4  md:rounded animate-pulse md:p-6 h-full"
  >
    <div className="flex md:flex-row flex-col items-center mt-4">
      ...
      <div className="md:items-start flex-col flex items-center md:mt-0 mt-3">
    ...
    <div className="h-2.5 bg-gray-200 rounded-full dark:bg-gray-400 w-48 mb-4 mt-10"></div>
    ...
    <div className="flex md:flex-row flex-col items-center justify-around flex-row h-48 mb-10 mt-7 bg-gray-300 rounded dark:bg-gray-400">
      <svg
